  ...
  <tr>
	...
	for(Repuestos r : listaR)
	{
		...
		<form method="post" action="ServletProductos?Param=<%=r.getId()%>">
			...
			<td><%=r.getProveedor().getNombre()%></td></td>
			<td> <input type="submit" name="btnEliminarRepuestos" value="Eliminar"> </td>
			</tr>
		</form>
		<%
	}
...
<input type="submit" name="btnEliminar2" value="<<" onClick="location.href='ServletProductos?Param=Eliminar&pag=prev'" style="position:relative; top:60%; left:40% ; transform:translate(-50%,-50%)">
<button style="position:relative; top:60%; left:42% ; transform:translate(-50%,-50%)"><%= request.getAttribute("pagina") %></button> 
<input type="submit" name="adelantar" value=">>" onClick="location.href='ServletProductos?Param=Eliminar&pag=next'" style="position:relative; top:60%; left:45% ; transform:translate(-50%,-50%)">
