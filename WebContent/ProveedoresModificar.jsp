...
<body>
	...
	<jsp:include page="Footer.jsp"/>
		...
		<h2>Lista de Proveedores a Modificar</h2>
		<div id="contenedor">
  ...
  <tr>
	...
	%>
		<form method="post" action="ServletProveedores?Param=<%=a.getIdProveedores()%>">
			...
			<td><input type="text" name="Telefonotxt" value="<%=a.getTelefono()%>" required pattern="^[0-9]*$"></td>			
			<td>
			<%
			...
			<td> <input type="submit" name="btnModificarProveedores" value="Modificar"> </td>
			</tr>
		</form>
		<%
	}
...
<input type="submit" name="btnEliminar2" value="<<" onClick="location.href='ServletProveedores?Param=Modificar&pag=prev'" style="position:relative; top:60%; left:40% ; transform:translate(-50%,-50%)";>
<button style="position:relative; top:60%; left:42% ; transform:translate(-50%,-50%)"><%= request.getAttribute("pagina") %></button> 
<input type="submit" name="adelantar" value=">>" onClick="location.href='ServletProveedores?Param=Modificar&pag=next'" style="position:relative; top:60%; left:45% ; transform:translate(-50%,-50%)">
