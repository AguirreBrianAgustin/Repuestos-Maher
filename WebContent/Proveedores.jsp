...
<nav class="w3-sidebar w3-bar-block w3-collapse w3-large w3-theme-l5 w3-animate-left" id="mySidebar">
  ...
  <a class="w3-bar-item w3-button w3-hover-black" href="#">Clientes</a>
  <a class="w3-bar-item w3-button w3-hover-black" href="#">Nuestras marcas</a>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
      <h1 class="w3-text-teal">Repuestos Maher</h1>
      <p> Proveedores</p>
      
      <h2>Elija una opción</h2>

			<div class="btn-group">
  				<button class="button">Lista de proveedores</button>
  				<button class="button">Agregar un proveedor</button>
