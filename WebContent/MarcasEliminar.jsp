   ...
   <th>Opcion</th>
	...
	for(Marcas a : listaA)
	{
		...
		<form method="post" action="ServletMarcas?Param=<%=a.getId()%>">
			<tr><td><%=a.getId()%></td><td><%=a.getNombre()%></td>
			...
			<td> <input type="submit" name="btnEliminarMarcas" value="Eliminar"> </td>
			</tr>
		</form>
		<%
	}
...
<input type="submit" name="btnEliminar2" value="<<" onClick="location.href='ServletMarcas?Param=Eliminar&pag=prev'" style="position:relative; top:60%; left:40% ; transform:translate(-50%,-50%)";>
<button style="position:relative; top:60%; left:42% ; transform:translate(-50%,-50%)"><%= request.getAttribute("pagina") %></button> 
<input type="submit" name="adelantar" value=">>" onClick="location.href='ServletMarcas?Param=Eliminar&pag=next'" style="position:relative; top:60%; left:45% ; transform:translate(-50%,-50%)">
