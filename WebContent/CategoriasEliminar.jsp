...
<table  class="table table-striped table-dark">
  ...
  <tr>
       ...
       <form method="post" action="ServletCategorias?Param=<%=a.getId()%>">
			<tr><td><%=a.getId()%> </p></td><td><%=a.getNombre()%></td>
...
<%
			...
			<td> <input type="submit" name="btnEliminarListarcategorias" value="Eliminar"  class="btn btn-secondary"> </td>
			</tr>
		</form>
...
<input type="submit" name="btnEliminar2" value="<<" onClick="location.href='ServletCategorias?Param=Eliminar&pag=prev'" style="position:relative; top:60%; left:40% ; transform:translate(-50%,-50%)";>
<button style="position:relative; top:60%; left:42% ; transform:translate(-50%,-50%)"><%= request.getAttribute("pagina") %></button> 
<input type="submit" name="adelantar" value=">>" onClick="location.href='ServletCategorias?Param=Eliminar&pag=next'" style="position:relative; top:60%; left:45% ; transform:translate(-50%,-50%)">
